...
const BarChart: FC<linePieChart> = (props: linePieChart) => {
  const options: Highcharts.Options = {
    ...
    yAxis: {
      tickPositions: props.yAxis ?? [0, 10000, 20000, 30000, 40000, 50000, 60000],
      labels: {
    ...
    series: [
      {
        type: "column", // Type "column" pour un bar chart vertical
